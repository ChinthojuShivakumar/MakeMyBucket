...
export default function Header() {
  ...
  return (
    <div className="Header flex items-center overflow-x-hidden justify-center font-nunito">
      <div className="text-white">
        <h1 className="font-nunito">Explore Incredible Destination With Us</h1>
      </div>
      <div className="search-conainer w-[70%] rounded-2xl bg-gray md:w-[90%] mt-10">
        ...
        <div className="search-container-children border-2 border-black-100">
          ...
          <div className="activities w-full">
            ...
            <div className="">
              <input
                ...
                className="  border-0 rounded-md focus:outline-none  "
          ...
          <div className="font-nunito">
            <button
              ...
              className="button-khart  uppercase text-white bg-darkslateblue-100 py-7 max-sm:py-2 md:ml-[-30px] md:mt-2 lg:mt-0 lg:ml-0  px-7 md:px-5 lg:py-10 lg:px-7 rounded-sm font-nunito">
              Search
            </button>
          </div>
      ...
      <div className="near-me p-8 my-2 w-[80%] relative -top-5 font-nunito font-semibold">
        <img className="" alt="" src="/gps-fixed.svg" />
        <p style={{ marginLeft: "10px", padding:"3px" }}>Experiences Near Me</p>
      </div>
    </div>
  );
}
