...
function DrawerAppBar(props) {
  ...
  const drawer = (
    <div style={{ display: "flex" }} className="drawerAlignment font-nunito">
  ...
  return (
    <div>
      <Box sx={{ display: "flex" }}>
        ...
        <AppBar
          id="mynav"
          className="Navbar md:h-28 bg-white flex flex-row text-[15px] font-nunito"
          style={{ background: "#f8f9fa", position: "fixed" }}
          component="nav"
        >
          <div className="yellow-bar">
            Book tours, attractions & things to do with Make My Bucket
          </div>
