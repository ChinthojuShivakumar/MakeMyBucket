...
export default function Activity() {
  ...
  return (
    <div className="Activity font-nunito">
          ...
          return (
            <div className="activity-card">
              ...
              <div className="card-footer">
                ...
                <div className="btn-book rounded-lg bg-ghumore-orange flex flex-row py-1.5 px-6 items-center justify-start text-center text-xs w-48">
                  <div className="  text-white leading-[132%] font-medium text-center text-lg">
