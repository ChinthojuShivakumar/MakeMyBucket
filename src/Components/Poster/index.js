...
export default function Poster() {
  ...
  const Component = (props) => {
    ...
    return (
      ...
      >
        <div className=" text-[30px]  md:text-4xl font-nunito font-semibold font-outfit text-center [text-shadow:0px_2px_3px_rgba(0,_0,_0,_0.25)]">{`Sign Up with us & Explore the World`}</div>
