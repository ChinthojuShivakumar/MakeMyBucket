...
export default function Poster() {
  ...
  const Component = (props) => {
    ...
    return (
      <div
        style={{ backgroundImage: `url(${loaded || props.placeholder})`, fontFamily:"nunito" }}
        className={`Poster  w-[1920px] h-[400px]  bg-cover bg-no-repeat bg-[top] font-nunito`}

      >
        <div className=" text-[30px]  md:text-4xl font-nunito font-semibold  text-center [text-shadow:0px_2px_3px_rgba(0,_0,_0,_0.25)] ">Sign Up with us & Explore the World</div>
